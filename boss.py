...
class Boss:
    def __init__(self, x, y, ai_brain, boss_config):
        ...
        # Soporte tanto para "hp" como "max_hp" para evitar errores
        self.max_hp = boss_config.get("max_hp", boss_config.get("hp", 300))
        self.hp = self.max_hp

        self.name = boss_config.get("name", "Boss Desconocido")
        self.folder = boss_config.get("folder", "boss")
